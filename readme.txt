...
Run Uncas.WebTester.ConsoleApp.exe without arguments which to uses the values from the config file.

Or use command-line input syntax: Uncas.WebTester.ConsoleApp.exe -url http://www.google.com -maxPages 100 -connectionString "Server=...;Database=...;Integrated Security=true" -matches http://www.google.com
